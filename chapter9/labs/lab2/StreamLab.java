...
public class StreamLab {
    ...
    public static void main(String[] args) {
        ...
        IntStream.rangeClosed(1, 20).forEach(n -> System.out.print(n + " "));
        System.out.println();
        ...
        numbers.stream()
                ...
                .mapToInt(n -> n * n)
                .average()
                .ifPresent(avg -> System.out.println("짝수 제공 평균: " + avg));
        ...
        System.out.println("학년별 최고점: " + topByGrade);
